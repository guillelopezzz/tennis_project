...
'''Esta función recibe la base de datos atp_matches_{year}.csv y calcula las estadísticas medias para cada jugador de las establecidas en el programa.
Cada estadística se multiplica por un número escalado entre 0.5 y 1 que representa los puntos en el ranking de la otra persona.
Para tener en cuenta: pueden haber jugadores que no tengan estadísticas porque sus estadísticas no aparecen en ningún partido'''